...
import 'package:mist5_mobile/ad_helper.dart';
                        ...
                        if (snapshot.connectionState ==
                          ...
                          return Container(
                            decoration: BoxDecoration(
                              ...
                              border: Border(
                                right: BorderSide(
                                  color: Color.fromARGB(255, 219, 37,
                                      0), // Color of the right border
                                  width: 8, // Width of the right border
                                ),
                                top: BorderSide(
                                  color: Color.fromARGB(255, 219, 37,
                                      0), // Color of the top border
                                  width: 2, // Width of the top border
                                ),
                                bottom: BorderSide(
                                  color: Color.fromARGB(255, 219, 37,
                                      0), // Color of the bottom border
                                  width: 2, // Width of the bottom border
                                ),
                                left: BorderSide(
                                  color: Color.fromARGB(255, 219, 37,
                                      0), // Color of the left border
                                  width: 2, // Width of the left border
                                ),
                              ),
                            ),
                        ...
                        if (snapshot.connectionState ==
                          ...
                          return Container(
                            decoration: BoxDecoration(
                              ...
                              border: Border(
                                right: BorderSide(
                                  color: Color.fromARGB(255, 6, 152,
                                      62), // Color of the right border
                                  width: 8, // Width of the right border
                                ),
                                top: BorderSide(
                                  color: Color.fromARGB(255, 6, 152,
                                      62), // Color of the top border
                                  width: 2, // Width of the top border
                                ),
                                bottom: BorderSide(
                                  color: Color.fromARGB(255, 6, 152,
                                      62), // Color of the bottom border
                                  width: 2, // Width of the bottom border
                                ),
                                left: BorderSide(
                                  color: Color.fromARGB(255, 6, 152,
                                      62), // Color of the left border
                                  width: 2, // Width of the left border
                                ),
                              ),
                            ),
